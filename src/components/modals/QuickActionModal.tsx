...
const QuickActionModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className={`sm:max-w-md bg-gradient-to-br ${
          colorScheme === "dark"
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-xl gradient-text font-bold">
            {title}
          </DialogTitle>
        </DialogHeader>
            ...
            {actions.map((actionItem, index) => {
              ...
              return (
                <Button
                  key={index}
                  variant="ghost"
                  className={`w-full justify-start h-auto p-4 hover:bg-gradient-to-r cursor-pointer 
                    ...
                    } transition-all duration-300 hover:shadow-md rounded-lg`}
                  onClick={() => {
                ...
                >
                  <div className="flex items-start space-x-3 text-left">
                    <div className="w-10 h-10 gradient-button rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
