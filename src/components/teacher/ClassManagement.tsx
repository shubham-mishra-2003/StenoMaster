    ...
    <div className="space-y-4 sm:space-y-6 p-2 sm:p-4 lg:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent
            className={`max-w-sm sm:max-w-md mx-4 backdrop-blur-xl border-0 shadow-2xl ${
              colorScheme === "dark"
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`bg-white/60 border-gray-200 focus:ring-2 focus:ring-blue-500 ${
                    colorScheme === "dark"
              ...
              <CardContent className="space-y-4 relative z-10">
                ...
                <div className="flex items-center space-x-2">
                  <Badge
                    ...
                    className={`${
                      colorScheme === "dark"
                        ? "bg-gradient-to-r from-blue-950 to-purple-950 text-blue-300"
                ...
                <Button
                  variant="outline"
                  className={`w-full border-blue-200 transition-all duration-300 ${
                    colorScheme === "dark"
                      ? "dark:border-blue-800 dark:hover:from-blue-950 dark:hover:to-purple-950"
      ...
      {classes.length === 0 && (
        <Card
          className={`relative overflow-hidden backdrop-blur-xl border-0 shadow-lg ${
            colorScheme === "dark"
              ? "modal-gradient-dark-bg"
              : "modal-gradient-light-bg"
          }`}
